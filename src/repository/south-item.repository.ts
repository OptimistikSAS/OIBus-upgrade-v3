...
import { SouthConnectorItemCommandDTO, SouthConnectorItemDTO, SouthConnectorItemSearchParam } from '../model/south-connector.model';
...
export default class SouthItemRepository {
   ...
   */
  createSouthItem(southId: string, command: SouthConnectorItemCommandDTO, id = generateRandomId(6)): SouthConnectorItemDTO {
    const insertQuery =
